...
//Круговая диаграмма
$slicesIndicators = array_slice($fakeIndicatorData, 40);
$slicesCountries = array_slice($fakeCountryData, 40);

$graph1 = new Graph\PieGraph(700, 400);
$graph1->title->Set("A Simple Pie Plot");
$graph1->SetBox(true);

$plot1 = new Plot\PiePlot($slicesIndicators);
$plot1->SetLegends($slicesCountries);
$plot1->ShowBorder();
...
$slicesAges = array_slice($fakeAgeData, 0, 10);
$slicesNames = array_slice($fakeNameData, 0, 10);
...
$graph2->xaxis->SetTickLabels($slicesNames);
$graph2->yaxis->title->Set("Indicator");

$plot2 = new Plot\BarPlot($slicesAges);
...
//Линейная диаграмма
$slicesIndicators2 = array_slice($fakeIndicatorData, 10, 10);
$slicesCountries2 = array_slice($fakeCountryData, 10, 10);
...
$graph3->xaxis->SetTickLabels($slicesCountries2);
$graph3->xgrid->SetColor('#E3E3E3');

// Create line
$plot3 = new Plot\LinePlot($slicesIndicators2);
