<form action="/authorization/controllers/signin/reg.php" method="post">
  ...
  <input style="width:40%; margin-right:50%;" type="submit" value="Зарегистироваться" id="register">
  <div class="reg">Уже есть аккаунт? <a href="/authorization/?action=signin">Войти</a></div>
</form>