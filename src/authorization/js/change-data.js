let form = document.querySelector('form.change-form');
...
document.querySelector('form.change-form').onsubmit = function () {
  ...
  if (!validateData(fullName, email, tel)){
    ...
    document.querySelector('form.change-form').submit();
